...
@WebMvcTest(controllers = PaymentConfigAuthTest.DummyController.class)
@Import({PaymentConfigAuthTest.DummyController.class, PaymentConfig.class})
@TestPropertySource(properties = {
 ...
 class PaymentConfigAuthTest {
    ...
    @Test
    void whenAuthEnabled_apiRequiresAuth_publicUnauthenticatedGet401() throws Exception {
    ...
    @Test
    void corsPreflight_isPermitted_andReturnsCorsHeaders() throws Exception {
